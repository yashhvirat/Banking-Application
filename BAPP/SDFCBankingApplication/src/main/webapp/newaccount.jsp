...
<p></p>
<p></p>
<h3 style="color:red">&ensp;OPEN ACCOUNT FORM&ensp;</h3><p></p>
...
<b>Confirm Password:</b>&ensp;<input type="password" name="cnfpassword"><p></p>
<b>Amount:</b>&ensp;<input type="text" name="amount"><p></p>
<b>Address:</b>&ensp;<input type="text" name="address"><p></p>
<b>Mobile Number:</b>&ensp;<input type="text" name="mobile_number"><p></p>
