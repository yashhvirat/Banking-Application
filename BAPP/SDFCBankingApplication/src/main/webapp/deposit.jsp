...
<p></p>
<p></p>
<h3 style="color:red">&ensp;DEPOSIT AMOUNT FORM&ensp;</h3><p></p>
...
<b>Deposit Amount:</b>&ensp;<input type="text" name="amount"><p></p>
<center><input type="submit" value="Deposit">&ensp;&ensp;&ensp;<input type="submit" value="Clear"></center><p></p>
