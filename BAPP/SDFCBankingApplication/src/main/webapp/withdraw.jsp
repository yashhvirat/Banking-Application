...
<p></p>
<p></p>
<h3 style="color:red">&ensp;WITHDRAW AMOUNT FORM&ensp;</h3><p></p>
...
<b>Withdraw Amount:</b>&ensp;<input type="text" name="amount"><p></p>
<center><input type="submit" value="Withdraw">&ensp;&ensp;&ensp;<input type="submit" value="Clear"></center><p></p>
